...
/**
* CalcApp/MultiplicationPOA.java .
...
public abstract class MultiplicationPOA extends org.omg.PortableServer.Servant
 implements CalcApp.MultiplicationOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // CalcApp/Multiplication/mult
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
       ...
       case 1:  // CalcApp/Multiplication/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
  ...
  private static String[] __ids = {
    "IDL:CalcApp/Multiplication:1.0"};

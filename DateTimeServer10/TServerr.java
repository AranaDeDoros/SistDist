...
public TServerr(String[] args, String refFile) {
if (args.length < 1) {
...
putRef(new TimeServerPOATie(
new TimeServerDelegate())._this(orb), refFile);
else
putRef(new DateTimeServerPOATie(
new DateTimeServerDelegate())._this(orb), refFile);

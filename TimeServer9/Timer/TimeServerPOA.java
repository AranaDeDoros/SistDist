 ...
 implements Timer.TimeServerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("_get_hours", new java.lang.Integer (0));
    _methods.put ("_get_minutes", new java.lang.Integer (1));
    _methods.put ("_get_seconds", new java.lang.Integer (2));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // Timer/TimeServer/_get_hours
       {
         int $result = (int)0;
         $result = this.hours ();
         out = $rh.createReply();
       ...
       case 1:  // Timer/TimeServer/_get_minutes
       {
         int $result = (int)0;
         $result = this.minutes ();
         out = $rh.createReply();
       ...
       case 2:  // Timer/TimeServer/_get_seconds
       {
         int $result = (int)0;
         $result = this.seconds ();
         out = $rh.createReply();
